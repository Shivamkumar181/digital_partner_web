    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
              ...
              {images.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white rounded-full w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center transition backdrop-blur-sm text-lg sm:text-xl"
                  >
                    ‹
                  </button>
                  <button
                    ...
                    className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white rounded-full w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center transition backdrop-blur-sm text-lg sm:text-xl"
                  >
                    ›
                  </button>
                    ...
                    {images.map((_, i) => (
                      <button
                        ...
                        className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-all ${
                          i === activeImage ? "bg-white w-3 sm:w-4" : "bg-white/50"
                        }`}
                      />
                    ))}
                  </div>
          ...
          <div className="p-4 sm:p-5 md:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
              <div className="bg-gray-800/50 rounded-xl p-3 sm:p-4 border border-gray-700">
                <div className="flex items-center gap-2 mb-1 sm:mb-2">
                  <DollarSign size={16} className="sm:w-[18px] sm:h-[18px] text-purple-400" />
              ...
              <div className="bg-gray-800/50 rounded-xl p-3 sm:p-4 border border-gray-700">
                <div className="flex items-center gap-2 mb-1 sm:mb-2">
                  <Calendar size={16} className="sm:w-[18px] sm:h-[18px] text-purple-400" />
                  <p className="text-xs sm:text-sm text-gray-400">Deadline</p>
                </div>
              ...
              <div className="bg-gray-800/50 rounded-xl p-3 sm:p-4 border border-gray-700">
                <div className="flex items-center gap-2 mb-1 sm:mb-2">
                  <User size={16} className="sm:w-[18px] sm:h-[18px] text-purple-400" />
              ...
              <div className="bg-gray-800/50 rounded-xl p-3 sm:p-4 border border-gray-700">
                <div className="flex items-center gap-2 mb-1 sm:mb-2">
                  <Briefcase size={16} className="sm:w-[18px] sm:h-[18px] text-purple-400" />
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-4 sm:mb-6">
              {currentProject.skills?.map((skill, index) => (
                <span
                  key={index}
                  className="px-2 sm:px-3 py-1 bg-purple-500/10 text-purple-400 rounded-lg text-xs sm:text-sm border border-purple-500/30"
                >
                  {skill}
                </span>
              ))}
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              {canContribute && !showContributionForm && (
                <button
                  onClick={() => setShowContributionForm(true)}
                  className="flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-4 sm:px-6 py-2 rounded-lg font-semibold hover:shadow-lg hover:shadow-purple-500/30 transition-all text-sm sm:text-base"
                >
              ...
              <button
                onClick={() => setShowChat(!showChat)}
                className="flex items-center justify-center gap-2 bg-gray-800 text-gray-300 px-4 sm:px-6 py-2 rounded-lg font-semibold hover:bg-gray-700 transition-all border border-gray-700 text-sm sm:text-base"
              >
          ...
          {showContributionForm && (
            ...
            >
              <motion.div
                ...
                animate={{ scale: 1, y: 0 }}
                exit={{ scale: 0.9, y: 20 }}
                className="bg-gradient-to-br from-gray-900 to-black rounded-2xl max-w-2xl w-full border border-purple-500/30 shadow-2xl m-2 sm:m-0"
                onClick={(e) => e.stopPropagation()}
              >
                <div className="p-4 sm:p-5 md:p-6">
                  ...
                  >
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-3 sm:px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition text-sm sm:text-base"
                        rows="4"
                        required
                        placeholder="Describe your contribution in detail..."
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        multiple
                        onChange={handleFileChange}
                        className="w-full px-3 sm:px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-purple-500 text-sm sm:text-base"
                        accept=".pdf,.doc,.docx,.jpg,.png"
                      />
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 pt-3 sm:pt-4">
                      <button
                        type="submit"
                        className="w-full sm:flex-1 bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-2 sm:py-2.5 rounded-lg font-semibold hover:shadow-lg transition-all text-sm sm:text-base"
                      >
                        Submit Contribution
                      </button>
                      <button
                        type="button"
                        onClick={() => setShowContributionForm(false)}
                        className="w-full sm:flex-1 bg-gray-800 text-gray-300 py-2 sm:py-2.5 rounded-lg font-semibold hover:bg-gray-700 transition-all text-sm sm:text-base"
                      >
                        Cancel
                      </button>
                    </div>
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="mt-4 sm:mt-6 bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-xl rounded-2xl border border-gray-700 p-4 sm:p-5 md:p-6"
        >
          ...
          {contributions && contributions.length > 0 ? (
            <div className="space-y-3 sm:space-y-4">
              {contributions.map((contribution, index) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ delay: index * 0.1 }}
                  className="bg-gray-800/30 rounded-xl p-4 sm:p-5 border border-gray-700 hover:border-purple-500/30 transition-all"
                >
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 sm:gap-3 mb-2 sm:mb-3">
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
                      {contribution.paymentStatus === "paid" && (
                        <span className="px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-xs bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 flex items-center gap-1">
                          <CreditCard size={10} className="sm:w-3 sm:h-3" />
                          Paid
                        </span>
                      )}
                      <span
                        className={`px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[10px] sm:text-sm ${
                          contribution.status === "approved"
                            ? "bg-emerald-500/20 text-emerald-400 border border-emerald-500/30"
                            : contribution.status === "rejected"
                              ? "bg-red-500/20 text-red-400 border border-red-500/30"
                  ...
                  <p className="text-gray-300 mt-2 mb-2 text-sm sm:text-base">
                    {contribution.description}
                  </p>
                  <p className="text-base sm:text-lg font-bold text-purple-400 mb-2 sm:mb-3">
                    ${contribution.amount}
                  </p>
                  ...
                  {contribution.files && contribution.files.length > 0 && (
                    <div className="mt-2 sm:mt-3 mb-2 sm:mb-3">
                      <p className="text-xs sm:text-sm text-gray-400 mb-1.5 sm:mb-2">Attachments:</p>
                        ...
                        {contribution.files.map((file, idx) => {
                          ...
                          return canDownload ? (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-1 text-purple-400 hover:text-purple-300 text-[10px] sm:text-sm bg-purple-500/10 px-2 sm:px-3 py-1 rounded-lg transition border border-purple-500/30"
                            >
                            ...
                            <span
                              key={idx}
                              className="flex items-center gap-1 text-gray-500 text-[10px] sm:text-sm bg-gray-700/50 px-2 sm:px-3 py-1 rounded-lg cursor-not-allowed"
                            >
                  ...
                  {/* Feedback */}
                  {contribution.clientFeedback && (
                    <div className="mt-2 sm:mt-3 bg-gray-800/50 rounded-lg p-2 sm:p-3 border border-gray-700">
                  ...
                  {isClient &&
                    ...
                    contribution.paymentStatus !== "paid" && (
                      <button
                        onClick={() => handleMarkPaid(contribution)}
                        disabled={payingId === contribution._id}
                        className="mt-3 w-full bg-emerald-600 hover:bg-emerald-700 disabled:opacity-60 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-semibold transition flex items-center justify-center gap-2"
                      >
                        {payingId === contribution._id ? (
                          <>
                          ...
                          <>
                            ...
                            <span className="text-xs sm:text-sm">Mark as Paid — Unlock Files</span>
                          </>
                        )}
                      </button>
                    )}
                  ...
                  {contribution.paymentStatus === "paid" && (
                    <div className="mt-3 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm text-center font-medium flex items-center justify-center gap-2">
                  ...
                  {isClient &&
                    ...
                    !contribution.certificateGenerated && (
                      <button
                        onClick={() => handleGenerateCertificate(contribution)}
                        className="mt-3 w-full bg-purple-600 hover:bg-purple-700 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-semibold transition flex items-center justify-center gap-2"
                      >
                  ...
                  {contribution.certificateGenerated && (
                    <div className="mt-3 bg-purple-500/10 border border-purple-500/30 text-purple-400 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm text-center flex items-center justify-center gap-2">
                  ...
                  {/* Review Form for Client */}
                  {isClient && contribution.status === "pending" && (
                    <div className="mt-3 sm:mt-4 space-y-2 sm:space-y-3 pt-3 sm:pt-4 border-t border-gray-700">
                      <textarea
                        placeholder="Add feedback (optional)..."
                        className="w-full px-2 sm:px-3 py-1.5 sm:py-2 bg-gray-800 border border-gray-700 rounded-lg text-white text-xs sm:text-sm focus:outline-none focus:border-purple-500"
                        rows="2"
                        value={reviewFeedback[contribution._id] || ""}
                        onChange={(e) =>
                          setReviewFeedback({
                      ...
                      <div className="flex flex-col sm:flex-row gap-2">
                        <button
                          ...
                          className="w-full sm:flex-1 bg-emerald-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg hover:bg-emerald-700 text-xs sm:text-sm font-medium transition flex items-center justify-center gap-2"
                        >
                          <Check size={12} className="sm:w-3.5 sm:h-3.5" />
                          Approve
                        </button>
                        <button
                          ...
                          className="w-full sm:flex-1 bg-red-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg hover:bg-red-700 text-xs sm:text-sm font-medium transition flex items-center justify-center gap-2"
                        >
            ...
            <div className="text-center py-8 sm:py-12">
              <FileText size={36} className="sm:w-12 sm:h-12 mx-auto text-gray-600 mb-3 sm:mb-4" />
              <p className="text-gray-400 text-sm sm:text-base">No contributions yet</p>
              {canContribute && (
                <button
                  onClick={() => setShowContributionForm(true)}
                  className="mt-3 sm:mt-4 inline-flex items-center gap-2 bg-purple-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg hover:bg-purple-700 transition text-sm sm:text-base"
                >
